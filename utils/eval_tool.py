...
def calc_detection_voc_mr_fppi(
        pred_bboxes, pred_labels, pred_scores, gt_bboxes, gt_labels,
        gt_difficults=None,
        iou_thresh=0.5):
    """Calculate miss rate and false positive per image (FPPI = FNR)
    based on evaluation metric of Caltech Pedestrian Dataset.

    This function calculates miss rate and FPPI of
    predicted bounding boxes obtained from a dataset which has :math:`N`
    images.
    The code is based on the evaluation code used in PASCAL VOC Challenge.
    ...
    Returns:
        ...
        * :obj:`mr`: A list of arrays. :obj:`mr[l]` is the miss rate \
            for class :math:`l`. If class :math:`l` does not exist in \
            either :obj:`pred_labels` or :obj:`gt_labels`, :obj:`prec[l]` is \
            set to :obj:`None`.
        * :obj:`fppi`: A list of arrays. :obj:`fppi[l]` is fppi \
            for class :math:`l`. If class :math:`l` that is not marked as \
            difficult does not exist in \
            :obj:`gt_labels`, :obj:`rec[l]` is \
            set to :obj:`None`.
